        ...
        <div class="collapse navbar-collapse text-center  justify-content-end" id="navbarDarkSupportedContent">
            <form class="form-inline my-2 my-lg-0">
                <ul class="navbar-nav text-right">
                    <li class="nav-item "><a class="nav-link" href="districts.php"> الاحياء <i class="fas fa-home"></i></a></li>
                    <li class="nav-item "><a class="nav-link" href="paths.php"> المسارات <i class="fas fa-home"></i></a></li>
                    <li class="nav-item "><a class="nav-link" href="trips.php"> الرحلات <i class="fas fa-home"></i></a></li>
                    <li class="nav-item "><a class="nav-link" href="index.php"> التقارير <i class="fas fa-home"></i></a></li>
                    <li class="nav-item "><span class="nav-link" > مرحبا مدير </span></li>
                    <li class="nav-item "><a class="nav-link" href="index.php"> تسجيل الخروج <i class="fas fa-home"></i></a></li>
                </ul>
