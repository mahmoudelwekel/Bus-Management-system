                ...
                <div class="col-12 bg-light text-warning text-center rounded p-4 my-3 w-md-50 ">
                    ...
                    <form>
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control text-right" placeholder="اسم المنطقه" aria-label="Recipient's username" aria-describedby="basic-addon2">
                        
                            <span class="input-group-btn">
                            <label for="imageUpload" class="btn btn-primary" style=" margin-bottom: 0px;">اختر صوره الحي</label>
                        ...
                        <button type="button" class="btn btn-success" ID="Button1">سجل الحي</button>
                    </form>
