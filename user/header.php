        ...
        <div class="collapse navbar-collapse text-center  justify-content-end" id="navbarDarkSupportedContent">
            <form class="form-inline my-2 my-lg-0">
                <ul class="navbar-nav text-right">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="trips.php"> الرحلات يوميه <i class="fas fa-home"></i></a>
                    </li>
                    <li class="nav-item active"><a class="nav-link" href="paths.php"> مسارات <i class="fas fa-home"></i></a>
                    </li>
                    <li class="nav-item active"><a class="nav-link" href="schedule.php"> جدولي <i class="fas fa-home"></i></a>
                    </li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="#notification" data-toggle="modal"
                                            data-target="#notification">    <span class="badge badge-danger badge-pill">2</span> الأشعارات </a></li>

                    <li class="nav-item"><a class="nav-link" href="#"><i class="fas fa-sign-out-alt"></i> الخروج </a>
                    </li>
                </ul>
