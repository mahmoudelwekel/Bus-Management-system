...
<div class="border border-secondary border-top-0" style="background-color:#2a81c9;padding-top:100px;padding-bottom:50px;">
  ...
  <input type="text" class="form-control text-right" placeholder="أضافة مسار جديد" aria-label="Recipient's username" aria-describedby="basic-addon2">
</div>
<br>
      ...
      <div class="col-12 bg-light text-warning text-center rounded py-5 px-4">
